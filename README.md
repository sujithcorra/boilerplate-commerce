...
- Preview: https://main--boilerplate-commerce--sujithcorra.hlx.page/
- Live: https://main--boilerplate-commerce--sujithcorra.hlx.live/
...
1. Open the `boilerplate-commerce` directory in your favorite IDE and start coding :)
